...
<body>
  ...
  <div class="container main-div">
        <div class="center-div">
            ...
            <?php
            if(isset($_GET['sub_ath'])){
                $name=$_GET['ath'];
                $con=mysqli_connect('localhost','root','','bookshelf');
                echo "<h3>Author | <strong> $name </strong></h3> <hr> <br>";
                if($con){
                    $q="select b_name, a_name, total_pages, genre, rating, p_year from books inner join author using(b_id) where a_name='$name' order by b_name;";
