...
<body>
  ...
  <div class="container main-div">
        <div class="center-div">
            ...
            <?php
            if(isset($_GET['sub_pub'])){
                $name=$_GET['pub'];
                $con=mysqli_connect('localhost','root','','bookshelf');
                echo "<h3>Publication | <strong> $name </strong></h3> <hr> <br>";
                if($con){
                    $q="select b_name, a_name, p_name from books inner join author using(b_id) inner join publisher using(b_id) where p_name='$name' order by b_name;";
