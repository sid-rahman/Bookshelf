...
<body>
  ...
  <div class="container main-div">
        <div class="center-div">
            ...
            <?php
            if(isset($_GET['sub_py'])){
                $name=$_GET['py'];
                $con=mysqli_connect('localhost','root','','bookshelf');
                echo "<h3>Published Year | <strong> $name </strong></h3> <hr> <br>";
                if($con){
                    $q="select b_name, a_name, p_name, p_year from books inner join author using(b_id) inner join publisher using(b_id) where p_year='$name' order by b_name;";
