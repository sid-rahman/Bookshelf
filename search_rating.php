...
<body>
  ...
  <div class="container main-div">
        <div class="center-div">
            ...
            <?php
            if(isset($_GET['sub_rat'])){
                $name=$_GET['rat'];
                $con=mysqli_connect('localhost','root','','bookshelf');
                echo "<h3>Ratings | <strong> $name </strong></h3> <hr> <br>";
                if($con){
                    $q="select b_name, a_name, rating from books inner join author using(b_id) where rating='$name' order by b_name;";
